...
const RSVPForm = () => {
  ...
  const submitRSVP = () => {
    ...
    setSubmitStatus('idle')
     ...
     form.method = 'POST'
     form.action = 'https://script.google.com/macros/s/AKfycbzuYygcZ5nB7SHbMd2HjPTSe4Oso9i7zccNfKAfWB0J5o7ffHjgF_bQIgcqr0Yizsz5/exec'
     form.target = '_blank'
              ...
              <div className="space-y-3">
                <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
                  ...
                  <a
                    ...
                    className="inline-block w-full text-center bg-gray-500 hover:bg-gray-500 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-300"
                  >
                    食事制限フォームへ →
                  </a>
                </div>
